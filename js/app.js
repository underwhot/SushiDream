    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".choose__slider")) new core(".choose__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".choose__button-prev",
                    nextEl: ".choose__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        sideMenu.addEventListener("mouseover", (function(e) {
            if (window.innerWidth > 991) body.classList.add("_side-menu-active");
        }));
        sideMenu.addEventListener("mouseout", (function(e) {
            if (window.innerWidth > 991) body.classList.remove("_side-menu-active");
        }));
